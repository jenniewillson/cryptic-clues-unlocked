    ...
    <div className="h-full flex flex-col justify-center items-center max-w-6xl mx-auto px-8">
      ...
      <section className="w-full space-y-6">
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 border-2 border-cyan-200 dark:border-cyan-700 rounded-2xl p-6 md:p-8">
          <div className="text-center mb-6">
            <p className="text-2xl md:text-4xl font-semibold text-foreground leading-relaxed">
              ...
              {' '} 
              <span className={step >= 3 ? 'bg-indigo-200/70 dark:bg-indigo-800/60 px-2 py-1 rounded font-semibold' : ''}>flower?</span>
              " (4)
            </p>
          </div>
        ...
        <div className="text-center">
          {step === 0 && (
            <Button onClick={next} size="lg" className="text-xl md:text-2xl px-8 md:px-12 py-5 md:py-6 rounded-xl">Show Definition 1</Button>
          )}
          {step === 1 && (
            <Button onClick={next} size="lg" className="text-xl md:text-2xl px-8 md:px-12 py-5 md:py-6 rounded-xl">Show Definition 2</Button>
          )}
          {step === 2 && (
            <Button onClick={next} size="lg" className="text-xl md:text-2xl px-8 md:px-12 py-5 md:py-6 rounded-xl">Show Definition 3</Button>
          )}
          {step === 3 && (

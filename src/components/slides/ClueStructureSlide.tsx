...
const ClueStructureSlide = () => {
  return (
    <div className="h-screen flex flex-col justify-center items-center max-w-6xl mx-auto px-8 py-4">
      <h1 className="text-5xl font-bold text-center text-foreground mb-8 bg-gradient-to-r from-purple-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
        The Anatomy of a Cryptic Clue
      </h1>
      
      <div className="space-y-8 w-full">
        <div className="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900/50 dark:to-blue-900/20 border-2 border-slate-200 dark:border-slate-700 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-900/20 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-700">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-4 border-2 border-emerald-200 dark:border-emerald-600">
                ...
                <p className="text-lg font-medium text-emerald-700 dark:text-emerald-400">• Beginning of clue</p>
                <p className="text-lg font-medium text-emerald-700 dark:text-emerald-400">• End of clue</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-900/30 dark:to-purple-900/20 rounded-2xl p-6 border-2 border-violet-300 dark:border-violet-700">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-4 border-2 border-violet-200 dark:border-violet-600">
                ...
                <p className="text-lg font-medium text-violet-700 dark:text-violet-400">• Indicators (signal the wordplay type)</p>
                <p className="text-lg font-medium text-violet-700 dark:text-violet-400">• Fodder (raw material for the answer)</p>
              </div>
            </div>
          </div>
        </div>

        <div className="bg-gradient-to-br from-slate-100 to-gray-100 dark:from-slate-800/50 dark:to-gray-800/50 rounded-2xl p-6 border-2 border-slate-300 dark:border-slate-600">

            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/30 dark:to-gray-900/20 rounded-2xl p-6 border-2 border-slate-300 dark:border-slate-600">
                <p className="text-2xl text-foreground mb-4">
                  "Correct <span className="bg-amber-200 dark:bg-amber-800 px-2 py-1 rounded font-semibold">ceremony</span>, <span className="bg-cyan-200 dark:bg-cyan-800 px-2 py-1 rounded font-semibold">we hear</span> (5)"
                </p>
                <div className="space-y-2 text-lg text-muted-foreground">
                  <p><span className="text-cyan-600 dark:text-cyan-400 font-semibold">Sound Indicator:</span> "we hear" (signals homophone)</p>
                  <p><span className="text-amber-600 dark:text-amber-400 font-semibold">Sounds Like:</span> "ceremony" = rite</p>
                </div>
              </div>

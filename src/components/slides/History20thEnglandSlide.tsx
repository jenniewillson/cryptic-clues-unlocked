...
const History20thEnglandSlide = () => {
  return (
    <div className="h-screen flex flex-col justify-center items-center max-w-6xl mx-auto px-8">
      <h1 className="text-5xl font-bold text-center text-foreground mb-10 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">
        History & Development – 20th Century England
      </h1>

      <section className="grid grid-cols-2 gap-8 w-full">
        <article className="bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 border-2 border-indigo-200 dark:border-indigo-700 rounded-2xl p-8 shadow-xl">
        ...
        <article className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-2 border-blue-200 dark:border-blue-700 rounded-2xl p-8 shadow-xl">
        ...
        <article className="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900/30 dark:to-emerald-900/30 border-2 border-teal-300 dark:border-teal-700 rounded-2xl p-8 shadow-xl">

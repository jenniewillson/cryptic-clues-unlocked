      ...
      <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 border-2 border-cyan-200 dark:border-cyan-700 rounded-2xl p-12 w-full">
        <div className="text-center mb-12">
          <p className="text-5xl font-semibold text-foreground mb-8 leading-relaxed">
            {currentStep >= 1 ? (
              <>
                "<span className="bg-cyan-200 dark:bg-cyan-800 px-2 py-1 rounded font-semibold">Introductions to</span> <span className="bg-amber-200 dark:bg-amber-800 px-2 py-1 rounded font-semibold">all toccatas, transposed uniformly, naturally eventually</span> <span className="bg-blue-200 dark:bg-blue-800 px-2 py-1 rounded font-semibold">harmonise</span> (6)"
              </>
            ) : (
        ...
        {currentStep === 1 && (
          <div className="grid grid-cols-3 gap-10 mb-12">
            <div className="bg-gradient-to-br from-cyan-100 to-blue-100 dark:from-cyan-900/30 dark:to-blue-900/20 rounded-2xl p-8 border-2 border-cyan-300 dark:border-cyan-600 text-center">
              ...
              <p className="text-3xl text-cyan-700 dark:text-cyan-300 font-medium">"Introductions to"</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-100 to-yellow-100 dark:from-amber-900/30 dark:to-yellow-900/20 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-600 text-center">
              ...
              <p className="text-3xl text-amber-700 dark:text-amber-300 font-medium">"all toccatas, transposed uniformly, naturally eventually"</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/20 rounded-2xl p-8 border-2 border-blue-300 dark:border-blue-600 text-center">
              ...
              <p className="text-3xl text-blue-700 dark:text-blue-300 font-medium">"harmonise"</p>
            </div>
          </div>
        )}
          ...
          {currentStep === 2 && (
            <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-900/20 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-600">
              ...
              <p className="text-3xl text-muted-foreground">
                First letters: <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">A</span>ll + <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">T</span>occatas + <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">T</span>ransposed + <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">U</span>niformly + <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">N</span>aturally + <span className="bg-emerald-200 dark:bg-emerald-700 px-1 rounded font-bold">E</span>ventually = ATTUNE
              </p>
            </div>
          )}
        </div>

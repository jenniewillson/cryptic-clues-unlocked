    ...
    <div className="w-full h-full flex flex-col justify-center items-center p-8 bg-gradient-to-br from-background to-muted/20">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-center text-primary mb-6">Daily papers</h2>
          
          <div className="bg-card p-8 rounded-lg border">
            <div className="flex items-center gap-3 mb-6">
              <Newspaper className="w-8 h-8 text-primary" />
              <h3 className="text-2xl font-semibold text-primary">Regular Cryptics: To your taste!</h3>
            </div>
            ...
            <div className="space-y-6 text-muted-foreground">
              ...
              <div className="space-y-4">
                <h4 className="text-lg font-semibold text-foreground">Papers to explore:</h4>

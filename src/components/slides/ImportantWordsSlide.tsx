        ...
        {currentStep >= 1 && (
          <div className="grid grid-cols-3 gap-10 mb-12">
            <div className="bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/20 rounded-2xl p-8 border-2 border-blue-300 dark:border-blue-600 text-center">
              ...
              <p className="text-3xl text-blue-700 dark:text-blue-300 font-medium">"Threat"</p>
            </div>
            ...
            {currentStep >= 2 && (
              <div className="bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/20 rounded-2xl p-8 border-2 border-green-300 dark:border-green-600 text-center">
                <h4 className="text-3xl font-semibold text-foreground mb-4">Chess Pieces</h4>
                <p className="text-3xl text-green-700 dark:text-green-300 font-medium">"rook" = R, "king" = K</p>
              </div>
            )}
            ...
            {currentStep >= 3 && (
              <div className="bg-gradient-to-br from-amber-100 to-yellow-100 dark:from-amber-900/30 dark:to-yellow-900/20 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-600 text-center">
                <h4 className="text-3xl font-semibold text-foreground mb-4">Key Word!</h4>
                <p className="text-3xl text-amber-700 dark:text-amber-300 font-medium">"IS" = I + S</p>
              </div>
            )}
          </div>
        )}
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-900/20 rounded-2xl p-6 border-2 border-emerald-300 dark:border-emerald-600">
                ...
                <p className="text-3xl text-muted-foreground">
                  R (rook) + I + S (from "is") + K (king) = RISK (threat)
                </p>
              </div>
